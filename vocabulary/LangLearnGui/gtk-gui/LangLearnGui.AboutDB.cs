...
namespace LangLearnGui
{
	public partial class AboutDB
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget LangLearnGui.AboutDB
			this.Name = "LangLearnGui.AboutDB";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child LangLearnGui.AboutDB.VBox
			...
			this.textview1.Buffer.Text = "\n\nLanguage Informant Course Player\nPre-alpha\n\nLicense:\nAffero General Public License\n\nCoding:\nBrian Bird and Jacob Riddle\n\nThis player might have Super Cow Powers.";
			...
			w3.Position = 0;
			// Internal child LangLearnGui.AboutDB.ActionArea
